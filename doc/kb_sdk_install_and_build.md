...
You will get a failure if the Docker daemon is not running when you invoke the above command.  See  [Install SDK Dependencies](kb_sdk_dependencies.md) for guidance.
