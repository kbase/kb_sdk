...
/**
 * <p>Original spec-file type: GetUserRolesParams</p>
 * <pre>
...
public class GetUserRolesParams {
    ...
    public GetUserRolesParams withUsers(List<String> users) {
        this.users = users;
        return this;
    }
    ...
    public GetUserRolesParams withListEveryUser(Long listEveryUser) {
        this.listEveryUser = listEveryUser;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((("GetUserRolesParams"+" [users=")+ users)+", listEveryUser=")+ listEveryUser)+", additionalProperties=")+ additionalProperties)+"]");
    }
