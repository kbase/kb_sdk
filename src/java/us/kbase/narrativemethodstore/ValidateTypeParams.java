...
/**
 * <p>Original spec-file type: ValidateTypeParams</p>
 * 
 * 
 */
...
public class ValidateTypeParams {
    ...
    public ValidateTypeParams withId(java.lang.String id) {
        this.id = id;
        return this;
    }
    ...
    public ValidateTypeParams withSpecJson(java.lang.String specJson) {
        this.specJson = specJson;
        return this;
    }
    ...
    public ValidateTypeParams withDisplayYaml(java.lang.String displayYaml) {
        this.displayYaml = displayYaml;
        return this;
    }
    ...
    public ValidateTypeParams withExtraFiles(Map<String, String> extraFiles) {
        this.extraFiles = extraFiles;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((("ValidateTypeParams"+" [id=")+ id)+", specJson=")+ specJson)+", displayYaml=")+ displayYaml)+", extraFiles=")+ extraFiles)+", additionalProperties=")+ additionalProperties)+"]");
    }
