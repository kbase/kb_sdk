...
/**
 * <p>Original spec-file type: ScriptOutputMapping</p>
 * <pre>
...
public class ScriptOutputMapping {

    @JsonProperty("input_parameter")
    private java.lang.String inputParameter;
    @JsonProperty("script_output_path")
    private List<String> scriptOutputPath;
    ...
    public ScriptOutputMapping withInputParameter(java.lang.String inputParameter) {
        this.inputParameter = inputParameter;
        return this;
    }

    @JsonProperty("script_output_path")
    public List<String> getScriptOutputPath() {
        return scriptOutputPath;
    }

    @JsonProperty("script_output_path")
    public void setScriptOutputPath(List<String> scriptOutputPath) {
        this.scriptOutputPath = scriptOutputPath;
    }

    public ScriptOutputMapping withScriptOutputPath(List<String> scriptOutputPath) {
        this.scriptOutputPath = scriptOutputPath;
        return this;
    }
    ...
    public ScriptOutputMapping withConstantValue(UObject constantValue) {
        this.constantValue = constantValue;
        return this;
    }
    ...
    public ScriptOutputMapping withNarrativeSystemVariable(java.lang.String narrativeSystemVariable) {
        this.narrativeSystemVariable = narrativeSystemVariable;
        return this;
    }
    ...
    public ScriptOutputMapping withTargetProperty(java.lang.String targetProperty) {
        this.targetProperty = targetProperty;
        return this;
    }
    ...
    public ScriptOutputMapping withTargetTypeTransform(java.lang.String targetTypeTransform) {
        this.targetTypeTransform = targetTypeTransform;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((((((("ScriptOutputMapping"+" [inputParameter=")+ inputParameter)+", scriptOutputPath=")+ scriptOutputPath)+", constantValue=")+ constantValue)+", narrativeSystemVariable=")+ narrativeSystemVariable)+", targetProperty=")+ targetProperty)+", targetTypeTransform=")+ targetTypeTransform)+", additionalProperties=")+ additionalProperties)+"]");
    }
